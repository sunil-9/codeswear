        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex">
              ...
              {/* <button className="flex ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">Check Out</button> */}
              <button onClick={() =>{addToCart(slug ,1,499,'wear-the-code','xl','black',imgUrl)} } className="flex ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">Add to cart</button>
            </div>
            ...
            <div className="flex mt-5">
              ...
              <button onClick={checkService} className="flex ml-auto text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded">Check</button>
            </div>
